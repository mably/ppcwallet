...
[![GoDoc](https://godoc.org/github.com/mably/ppcwallet/walletdb?status.png)]
(http://godoc.org/github.com/mably/ppcwallet/walletdb)
...
http://localhost:6060/pkg/github.com/mably/ppcwallet/walletdb

## Installation

```bash
$ go get github.com/mably/ppcwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/mably/ppcwallet/walletdb#example-package--BasicUsage)  
